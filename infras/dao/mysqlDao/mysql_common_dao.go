...
*/
func (m *CommonMysqlDao) GetOne(tableName string, where map[string]interface{}, selectField []string, result DaoMysqlSchema) error {
	if nil == m.db {
...
*/
func (m *CommonMysqlDao) GetMulti(tableName string, where map[string]interface{}, selectField []string, results interface{}) error {
	if nil == m.db {
		return errors.New("mysql.DB object couldn't be nil")
	}
	condition, values, err := builder.BuildSelect(tableName, where, selectField)
...
*/
func (m *CommonMysqlDao) Insert(tableName string, data []map[string]interface{}) (int64, error) {
	if nil == m.db {
...
@return LastInsertId int64						返回最新的插入id
*/
func (m *CommonMysqlDao) InsertIgnore(tableName string, data []map[string]interface{}) (int64, error) {
	if nil == m.db {
		return -1, errors.New("sql.DB object couldn't be nil")
	}
...
@return LastInsertId int64						返回最新的插入id
*/
func (m *CommonMysqlDao) InsertReplace(tableName string, data []map[string]interface{}) (int64, error) {
	if nil == m.db {
		return -1, errors.New("sql.DB object couldn't be nil")
	}
...
*/
func (m *CommonMysqlDao) Update(tableName string, where, data map[string]interface{}) (int64, error) {
	if nil == m.db {
		return -1, errors.New("sql.DB object couldn't be nil")
	}
...
*/func (m *CommonMysqlDao) Delete(tableName string, where map[string]interface{}) (int64, error) {
	if nil == m.db {
		return -1, errors.New("sql.DB object couldn't be nil")
	}
...
*/func (m *CommonMysqlDao) GetCount(tableName string, where map[string]interface{}) (int64, error) {
	if nil == m.db {
		return -1, errors.New("sql.DB object couldn't be nil")
	}
