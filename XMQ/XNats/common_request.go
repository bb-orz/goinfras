...
*/
func (c *commonNatsRequest) Request(subject string, v interface{}, replyPtr interface{}, timeout time.Duration) error {
	conn, err := c.pool.Get()
	if err != nil {
		return err
	}
...
*/
func (c *commonNatsRequest) RequestWithContext(ctx context.Context, subject string, msg interface{}, respPtr interface{}, timeout time.Duration) error {
	conn, err := c.pool.Get()
	if err != nil {
		return err
	}
